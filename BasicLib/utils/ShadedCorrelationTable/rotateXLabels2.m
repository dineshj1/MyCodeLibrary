function hh = rotateXLabels2( ax, angle, varargin )
%rotateXLabels2: rotate any xticklabels
%
%   hh = rotateXLabels2(ax,angle) rotates all XLabels on axes AX by an angle
%   ANGLE (in degrees). Handles to the resulting text objects are returned
%   in HH.
%
%   hh = rotateXLabels2(ax,angle,param,value,...) also allows one or more
